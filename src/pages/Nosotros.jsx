  ...
  return (
    <>
      ...
      <div className="section-nosotros">
        ...
        <h2 className="section-nosotros__title">Sobre BOXing Store Argentina</h2>

        <p className="section-nosotros__p"> Somos deportes de lucha, somos calidad y protección para el artista
